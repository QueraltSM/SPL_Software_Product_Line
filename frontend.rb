class Frontend
    ...
    <<~HTML
      ...
      .feature {
        width: calc(10% - 10px);
        background: linear-gradient(135deg, #d5f8e0, #c5e9e5, #d5f8e0);
        border-radius: 10px;
        padding: 40px;
        margin: 25px;
        text-align: center;
    ...
    def creation_item_form_scripts
      <<~HTML
      <script>
      function toggleFields() {
        ...
        const config = {
          News: {
            source: 'Source',
            url: 'Please enter the URL of the header image for the news.',
            description: 'Please provide a detailed description of the content. You can insert HTML code or plain text.'
          },
          Books: {
            source: 'Author',
            url: 'Please enter the URL of the book cover image.',
            description: 'Please provide a detailed description of the book.'
          },
          Recipes: {
            source: 'Chef',
            url: 'Please enter the URL of the dish photo.',
            description: 'Please provide a detailed description of the recipe.'
          },
          Movies: {
            source: 'Director',
            url: 'Please enter the URL of the movie trailer. It can be from YouTube.',
            description: 'Please provide a detailed description of the movie.'
          },
          Videos: {
            source: 'Channel',
            url: 'Please enter the URL of the video. It can be from YouTube.',
            description: 'Please provide a detailed description of the video.'
          },
          Music: {
            source: 'Singer / Band',
            url: 'Please enter the URL of the music video. It can be from YouTube.',
            description: 'Please provide a detailed description of the music.'
          },
          Podcasts: {
            source: 'Podcast Host',
            url: 'Enter the URL of an image for the podcast cover.',
            description: 'Include a comprehensive description of the episode or podcast, covering details like where it can be found across different platforms, URLs or hosting platforms.'
          },
          Videogames: {
            source: 'Company',
            url: 'Please enter the URL of an image for the game cover.',
            description: 'Provide a detailed description of the game, including its genre, gameplay features and any other relevant information.'
          },
          Art: {
            source: 'Creator',
            url: 'Enter the URL of an image of the artwork.',
            description: 'Provide a detailed description of the artwork, like information about the artistic style, the technique used, the theme or meaning of the artwork, historical or cultural context, and any other relevant details you would like to share.'
          },
          Events: {
            source: 'Creator',
            url: 'Please enter the URL of an image related to the event.',
            description: 'Provide a comprehensive description of the event, including details about its purpose, location, target audience, features, and any other relevant information you want to share.'
          }
        };
        sourceLabel.innerHTML = config[type].source;
        urlLabel.innerHTML = config[type].url;
        descriptionLabel.innerHTML = config[type].description;
      }
    </script>
    HTML
    end

    def creation_item_form
      <<~HTML
      <h4 class='center-text'>Creation of content</h4>
      <form action='/create_item' method='post' class='form-container'>
        <input type='hidden' name='_method' value='put'>
        <div class='form-group'>
          <label for='type'>Content type</label>
          <p>Please select the type of multimedia content you want to share.</p>
        ...
        <div class='form-group'>
          ...
          <p>Enter the title of the content.</p>
          <input type='text' id='title' name='title' class='form-control' required>
        </div>
        <div class='form-group' id='source-div'>
          <label id='source-label' for='source'>Source</label>
          <p>Enter the source of the content.</p>
          <input type='text' id='source' name='source' class='form-control' required>
        </div>
        <div class='form-group'>
          <label for='description'>Description</label>
          <p id='description-label'>Please provide a detailed description of the content. You can insert HTML code or plain text.</p>
          <textarea id='description' name='description' class='form-control' required></textarea>
        </div>
        <div id='url-div' class='form-group'>
          <label for='media_url'>Media URL</label>
          <p id='url-label'>Please enter the URL of the header image for the news.</p>
        ...
        <div class='form-group' id='date-div'>
          ...
          <p>Select the date of release.</p>
          <input type='date' id='date' name='date' class='form-control' min="1970-01-01" step="1" required>
        </div>
    ...
    def items_search_form_scripts(type)
      <<~HTML
      <script>
      ...
      return <<~HTML
        <form id='sort-form' style='margin-top: 20px;margin: 20px;'>
          <div style='display: flex; align-items: center; justify-content: flex-end;'>
            ...
            #{select_options(sb) unless type == 'Events'}
          </div>
        </form>
      HTML
    end
    
    def select_options(sb)
      <<~HTML
    ...
    def auto_resize(id)
      ...
      <script>
        ...
        document.getElementById('#{id}').addEventListener('input', auto_resize);
        window.addEventListener('load', auto_resize);
      </script>
      HTML
    end
